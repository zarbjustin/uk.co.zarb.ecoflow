...
Use STREAM 5000 Series Unit for verified 5 kWh-family hardware. It currently supports the STREAM AC 5000 (ES22) as a monitoring-only Homey Energy home battery because EcoFlow provides no supported public API for this model. It uses EcoFlow's app connection to report battery level, power, temperature, health and grid flow; controls are intentionally disabled. Additional 5000-series products remain hidden until their serial prefixes and telemetry are verified.
