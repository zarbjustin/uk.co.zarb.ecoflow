...
- **Per-unit monitors:** each physical inverter/battery (Ultra X Left/Right, AC Pro 1.1–1.4) is available as its own telemetry device without contributing separately to Homey Energy.
