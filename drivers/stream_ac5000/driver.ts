 ...
 * here. New physical-unit pairing is handled by `stream_5000_unit`; the
 * installation itself pairs through the unified `stream` Home Battery driver.
 * Existing test devices retain this ID but use the same non-Energy monitor role.
 */
